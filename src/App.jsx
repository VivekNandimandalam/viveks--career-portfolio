          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-300">
              <div className="flex items-center gap-4">
                <img src="/src/assets/microsoft_logo.jpg" alt="Microsoft" className="w-10 h-10 object-contain" loading="lazy" />
                <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-300">
              <div className="flex items-center gap-4">
                <img src="/src/assets/datadog_logo.jpg" alt="Datadog" className="w-10 h-10 object-contain" loading="lazy" />
                <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-500/30 transition-all duration-300">
              <div className="flex items-center gap-4">
                <img src="/src/assets/redwood_software_logo.jpg" alt="REDWOOD" className="w-10 h-10 object-contain" loading="lazy" />
                <div>
